...
T1.exe 5 5 3 1 "result_rastrigin_hcf.txt"
T1.exe 10 5 3 1 "result_rastrigin_hcf.txt"
T1.exe 30 5 3 1 "result_rastrigin_hcf.txt"

@REM Run foreach dimention for HillClimbing Best Improvement
T1.exe 5 5 3 2 "result_rastrigin_hcb.txt"
T1.exe 10 5 3 2 "result_rastrigin_hcb.txt"
T1.exe 30 5 3 2 "result_rastrigin_hcb.txt"

@REM Run foreach dimention for SimulatedAnnealing
T1.exe 5 5 3 3 "result_rastrigin_sa.txt"
T1.exe 10 5 3 3 "result_rastrigin_sa.txt"
T1.exe 30 5 3 3 "result_rastrigin_sa.txt"